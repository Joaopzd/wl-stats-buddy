...
export const THEMES: Record<ThemeKey, ThemeDef> = {
  ...
  "burnt-slate": {
    ...
    swatches: ["#353A3E", "#A73E18", "#D6D2CC"],
    bodyBg:
      "radial-gradient(ellipse 70% 45% at 50% -10%, oklch(0.55 0.17 38 / 0.10), transparent), radial-gradient(ellipse 55% 35% at 85% 100%, oklch(0.45 0.02 240 / 0.06), transparent)",
    vars: {
      "--background": "oklch(0.28 0.012 240)",
      "--foreground": "oklch(0.94 0.008 80)",
      "--card": "oklch(0.32 0.014 240)",
      "--card-foreground": "oklch(0.94 0.008 80)",
      "--popover": "oklch(0.30 0.014 240)",
      "--popover-foreground": "oklch(0.94 0.008 80)",
      "--primary": "oklch(0.55 0.17 38)",
      "--primary-foreground": "oklch(0.98 0.005 80)",
      "--secondary": "oklch(0.36 0.014 240)",
      "--secondary-foreground": "oklch(0.94 0.008 80)",
      "--muted": "oklch(0.36 0.012 240)",
      "--muted-foreground": "oklch(0.72 0.012 80)",
      "--accent": "oklch(0.68 0.14 50)",
      "--accent-foreground": "oklch(0.20 0.012 240)",
      "--destructive": "oklch(0.55 0.22 18)",
      "--destructive-foreground": "oklch(0.98 0.005 80)",
      "--success": "oklch(0.65 0.14 145)",
      "--success-foreground": "oklch(0.20 0.012 240)",
      "--border": "oklch(0.44 0.014 240 / 0.6)",
      "--input": "oklch(0.34 0.014 240)",
      "--ring": "oklch(0.55 0.17 38)",
      "--gradient-primary":
        "linear-gradient(135deg, oklch(0.55 0.17 38), oklch(0.68 0.14 50))",
      "--gradient-card":
        "linear-gradient(160deg, oklch(0.33 0.014 240), oklch(0.27 0.012 240))",
      "--gradient-hero":
        "radial-gradient(ellipse at top, oklch(0.55 0.17 38 / 0.14), transparent 60%), linear-gradient(180deg, oklch(0.30 0.014 240), oklch(0.24 0.012 240))",
    },
  },
  "navy-champagne": {
    key: "navy-champagne",
    ...
    swatches: ["#202632", "#F4E8D2", "#C9B98A"],
    bodyBg:
      "radial-gradient(ellipse 70% 45% at 50% -10%, oklch(0.92 0.04 85 / 0.08), transparent), radial-gradient(ellipse 55% 35% at 85% 100%, oklch(0.78 0.07 80 / 0.06), transparent)",
    vars: {
      "--background": "oklch(0.24 0.022 255)",
      "--foreground": "oklch(0.94 0.020 85)",
      "--card": "oklch(0.28 0.024 255)",
      "--card-foreground": "oklch(0.94 0.020 85)",
      "--popover": "oklch(0.26 0.024 255)",
      "--popover-foreground": "oklch(0.94 0.020 85)",
      "--primary": "oklch(0.92 0.04 85)",
      "--primary-foreground": "oklch(0.24 0.022 255)",
      "--secondary": "oklch(0.32 0.024 255)",
      "--secondary-foreground": "oklch(0.94 0.020 85)",
      "--muted": "oklch(0.32 0.020 255)",
      "--muted-foreground": "oklch(0.76 0.025 80)",
      "--accent": "oklch(0.78 0.07 80)",
      "--accent-foreground": "oklch(0.24 0.022 255)",
      "--destructive": "oklch(0.55 0.20 25)",
      "--destructive-foreground": "oklch(0.98 0.005 85)",
      "--success": "oklch(0.65 0.14 145)",
      "--success-foreground": "oklch(0.24 0.022 255)",
      "--border": "oklch(0.40 0.024 255 / 0.6)",
      "--input": "oklch(0.30 0.024 255)",
      "--ring": "oklch(0.92 0.04 85)",
      "--gradient-primary":
        "linear-gradient(135deg, oklch(0.92 0.04 85), oklch(0.78 0.07 80))",
      "--gradient-card":
        "linear-gradient(160deg, oklch(0.29 0.024 255), oklch(0.23 0.022 255))",
      "--gradient-hero":
        "radial-gradient(ellipse at top, oklch(0.92 0.04 85 / 0.14), transparent 60%), linear-gradient(180deg, oklch(0.26 0.024 255), oklch(0.20 0.020 255))",
    },
  },
  "forest-stone": {
    key: "forest-stone",
